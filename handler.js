...
global.dfail = (type, m, conn) => {
    let msg = {v
        rowner: '*Lu siapa?* • Command ini cuma buat ayang gw:v',
        owner: '*Lu owner?* • Command ini cuma Anggara syng yg bisa:v',
        mods: '*yahahha gk bisa* • Mampus',
        premium: '*Beli prem dulu* • Murah, cuma 20k permanen ',
        ...
        admin: '*Lu admin?* • Kasian Gk bisa, awokawok ',
        botAdmin: '*Bot nya bukan admin"-_* • Jadiin admin dulu lah njir ',
...
sourceUrl: sgc
    ...
    let msgg = {
    	unreg: 'Hamlo kak 👋\nLu harus daftar dulu, biar nyimpen di database bot \n\n➞ Klik tombol di bawah!!'
}[type]
if (msgg) return conn.sendButton(m.chat, `${global.htki} VERIFY ${global.htka}`, msgg, null, ['- Klik Oii-', '/verify'],m)
}
