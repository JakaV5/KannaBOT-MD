...
const listMessage = {
  text: tek,
  footer: '📮 *NOTE:* Jangan spam, dan kalo mau sewa bot, cuma 15k permanen, hubungi owner',
...
function ucapan() {
  ...
  let res = "Dah malem, tidur gih ☀️"
  if (time >= 4) {
    res = "Tch masih pagi dah main hp🌄"
  }
  if (time >= 10) {
    res = "Soreee jan jadi beban ya 🗿"
  }
  if (time >= 15) {
    res = "Dah sore nih, mandi gih 🌇"
  }
  if (time >= 18) {
    res = "Selamat malam, jangan begadang:v 🌙"
  }
  return res
}
